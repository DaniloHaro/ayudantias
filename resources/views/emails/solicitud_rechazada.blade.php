...
<head>
    <meta charset="UTF-8">
    <title>Solicitud No Seleccionada</title>
</head>
    ...
    <table align="center" width="600" cellpadding="0" cellspacing="0" style="margin: 0 auto; background-color: #ffffff;">
        ...
        <tr>
            <td style="padding: 20px;">
                <h2 style="text-align: center; color: #333333; margin-top: 0;">Resultado de Solicitud</h2>
                ...
                <p style="font-size: 15px; line-height: 1.6; color: #333333;">
                    Te informamos que tu solicitud de ayudantía para la asignatura <strong>{{ $nombreAsignatura }}, no ha sido seleccionada</strong>.
                </p>
